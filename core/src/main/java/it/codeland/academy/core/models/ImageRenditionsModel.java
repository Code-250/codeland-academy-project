		...
		if (StringUtils.isNotBlank(fileReference)) {
			...
			if (!ResourceUtil.isSyntheticResource(currentResource)) {
				...
				try {
					...
					String assetUrl = JcrUtils.getStringProperty(currentResource.adaptTo(Node.class), "fileReference", "");
					String assetUrlMob = JcrUtils.getStringProperty(currentResource.adaptTo(Node.class), "fileRefMobile", "");
