...
import it.codeland.academy.core.jobs.JobExecute;
...
public class ImportJob implements Runnable {
    ...
    @ObjectClassDefinition(name = "UCS Import Job", description = "Import CSV containing articles data")
    public static @interface Config {
        ...
        String CSVFilePath() default "/content/dam/academy-munyemana-unicredit/articles.csv";
                ...
                if (row.length == FIELDS_MAX) {
                    ...
                    if (articlePage != null) {
                        ...
                        if (articleContentNode != null) {
                            ...
                            logger.info("processed articles", statistics.processedRecords);
                        } else {
